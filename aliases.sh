...
alias gril='f() { branch=$(git symbolic-ref --short HEAD); git rebase -i HEAD~$1 $branch; unset -f f; }; f'
...
alias prpm='poetry run python -m'
alias pl='poetry lock ; poetry install --no-root'
